      ...
      <div className="space-y-8 pt-10 border-t border-border/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-medium">
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-bold">국제 자본의 이동 (Hot Money)</h4>
            ...
            <p className="text-sm text-foreground/70 leading-relaxed font-bold">
              ...
              수익을 주는 곳에서 자금을 빼내 높은 이자를 지급하는 국가로 자본을
              이동시킵니다. 이를 통해 금리가 높은 국가는 자본 유입을 경험하게
              되며, 이는 해당 국가의 금융 자산 수요를 높이는 결과를 낳습니다.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-foreground/70 leading-relaxed font-bold">
              ...
              늘어납니다. 이 과정에서 금리가 낮은 국가의 통화를 팔고 높은 국가의
              통화를 사게 되는데, 결과적으로 금리가 높은 국가의 통화 가치는
              상승(절상)하고 낮은 국가의 가치는 하락(절하)하게 됩니다.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-foreground/70 leading-relaxed font-bold">
              저금리 국가에서 돈을 빌려 고금리 국가의 자산에 투자하는 것을 '캐리
              트레이드'라고 합니다. 양국 간의 금리 격차가 벌어질수록 이러한
              거래가 활발해지며, 이는 고금리 국가의 자본시장 호황과 통화 가치
              상승을 더욱 부채질하는 동력이 됩니다.
            </p>
          </div>
          ...
          <div className="space-y-4 font-bold">
            ...
            <h4 className="text-xl font-bold">수입 물가와 중앙은행의 딜레마</h4>
            <p className="text-sm text-foreground/60 leading-relaxed italic">
              "통화 가치 하락은 물가 상승으로 이어집니다."
            </p>
            <p className="text-sm text-foreground/70 leading-relaxed">
              상대적 저금리로 인해 자국의 통화 가치가 떨어지면 수입하는 물건들의
              가격이 비싸지게 되어 국내 물가 상승(인플레이션)을 유발합니다.
              중앙은행은 금리를 낮게 유지해 경기를 부양하고 싶어도, 물가를 잡기
              위해 어쩔 수 없이 금리를 올려야 하는 상황에 직면하게 됩니다.
            </p>
          </div>
        </div>
      </div>
